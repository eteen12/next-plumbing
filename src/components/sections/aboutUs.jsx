...
export default function AboutUs() {
  return (
    <div className="w-full min-h-screen p-5 mt-32 grid grid-cols-1 gap-28 mx-auto sm:p-10 sm:grid-cols-[50%_50%] sm:gap-10  md:p-20 md:max-w-[850px] lg:max-w-[1000px] xl:max-w-[1300px]">
      ...
      <div className="flex flex-col justify-center sm:justify-normal sm:pt-10 sm:p-5 max-w-full sm:max-w-[340px] md:max-w-[380px] lg:max-w-[520px] mx-auto">
        ...
        <h2
          className="dm-sans text-2xl sm:text-3xl md:text-4xl lg:text-5xl 2xl:text-6xl"
          style={{ "--font-weight": "700" }}
        >
